...
// ============================================================
// NovelListActions - 列表行操作 (Phase 3.3)
// 软删除 / 恢复 / 编辑
// 严守 v0.6.1: NovelStatus 3 值, deleted 由 deleted_at 承载, 用 deleted prop
// ============================================================
import Link from "next/link";
import { useState, useTransition } from "react";
import { useRouter } from "next/navigation";

export function NovelListActions({ id, deleted }: { id: string; deleted: boolean }) {
