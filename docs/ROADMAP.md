...
2026-07-??~ ┌─ Phase 4: 打磨 ┐ 性能 + 动画 + 双仓库部署 + 部署加固 + 监控
            └─────────────────┘ ~3-5 天
```
...
- [x] 3.10 部署加固 (v0.17) — 2c4g 压测老板说不需要
...
^- [x] ~~**2c4g 部署验证 (黑必做)**~~ (老板 2026-07-02 22:22 拍板不做):
  - [x] ~~准备 2c4g 测试环境~~ (老板 2026-07-02 22:22 拍板不做, dev 4c16g 够)
...
| Q20 | 部署目标 (老板给的 2c4g? / 还是先 4c16g 跑?) | **老板 2026-07-02 22:22 拍板不做 (dev 4c16g 够)** |
